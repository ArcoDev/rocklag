<?php
  ...
  //TEXTOS PRODUCTOS 
  $titulo_producto = "Nuestros <span>productos</span>";
  $subtitulo = "Conoce algunos de nuestros productos";

  //TEXTOS TABLA Y CATALOGO
  $titulo_size = "Tamaños estandar";
  $size = "Tamaño";
  $paso = "Paso";
  $retenido = "Retenido";
  $descarga = "¡Descarga nuestro catálogo!";
  ...
  $sub_contacto = "¡Escríbenos! Nos pondremos en contacto a la brevedad";
  $nombre = "Nombre";
  $apellido = "Apellido";
  $email = "Email";
  $asunto = "Asunto";
